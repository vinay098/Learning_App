        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FacultyId = table.Column<string>(type: "longtext", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_BatchModules_BatchModuleBatchId_BatchModuleModul~",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Modules_LearnModuleId",
                        column: x => x.LearnModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_SkillModules_SkillModuleSkillId_SkillModuleModul~",
                        columns: x => new { x.SkillModuleSkillId, x.SkillModuleModuleId },
                        principalTable: "SkillModules",
                        principalColumns: new[] { "SkillId", "ModuleId" });
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Skills_SkillsId",
                        column: x => x.SkillsId,
                        principalTable: "Skills",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BatchFaculties", x => new { x.FacultyId, x.BatchId });
                    table.ForeignKey(
                        name: "FK_BatchFaculties_AspNetUsers_FacultyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_BatchModuleBatchId_BatchModuleModuleId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_LearnModuleId",
                table: "AspNetUsers",
                column: "LearnModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_SkillModuleSkillId_SkillModuleModuleId",
                table: "AspNetUsers",
                columns: new[] { "SkillModuleSkillId", "SkillModuleModuleId" });

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_SkillsId",
                table: "AspNetUsers",
                column: "SkillsId");
