...
namespace API.RSA
{
    public class RsaHelper : IRsaHelper
    {
        ...
        static string private_pem = @".\Keys\private.key.pem";
        static string public_pem = @".\Keys\public.pub.pem";
        ...
        private RSACryptoServiceProvider GetPublicKeyFromPemFile(string path)
        {
